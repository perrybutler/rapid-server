...
* Clustering - use a round-robin/random/intelligent point of access pass-thru system that redirects new clients to low activity worker processes/servers in the cluster. Handle C∞K, limited only by the distributed hardware available.
